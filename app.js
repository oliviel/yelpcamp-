...
app.use(require("express-session")({
    secret: "the iluminatis are watching you",
    resave: false,
...
//  COMMENTS ROUTES
 ...
 app.get("/campgrounds/:id/comments/new", isLoggIn, function(req, res){
 ...
 app.post("/campgrounds/:id/comments", isLoggIn, function(req, res){
